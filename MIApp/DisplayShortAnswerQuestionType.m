...
@synthesize shortAnswertTextField, heightConstraint, widthConstraint, CheckBoxButton;
...
- (void)viewDidLoad
{
    ...
    //set exception check box to noe by default
    checked = NO;
...
//checkbutton logic
//logic for raising exception to managers and moms
-(IBAction)checkButton:(id)sender{
    if (!checked){
        [CheckBoxButton setImage:[UIImage imageNamed:@"stock_form_checkbox.png"] forState:UIControlStateNormal];
        checked = YES;
        // Set a variable to be sent
    }
    
    else if (checked){
        [CheckBoxButton setImage:[UIImage imageNamed:@"checkbox_no.png"] forState:UIControlStateNormal];
        checked = NO;
    }
}
